...
```
## using terraform CLI command to manipulate a terraform deployment
code example
```
#main.tf
provider "aws" {
...
## VCS integration
VCS gitlab, can integrate with terraform workspace
to use VCS configs, Terraform Cloud needs to 
- access a list of repos
- register webhooks with your VCS provider
- download the contents of a repo


# terraform and k8s
## use terrafrom to create and manage infra on k8s
why deploy with terraform
* unified workflow
* full lifecycle management
* graph relationship

kubectl command to see current config info
```
